...
- [Synaptics Astra](https://www.synaptics.com/products/embedded-processors) - AI-Native IoT platform, SoC based, equipped with ARM Cortex-A and NPUs, with open source AI framework available.
